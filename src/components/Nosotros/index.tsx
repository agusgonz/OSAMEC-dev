      ...
      '>
        ...
        <div className='pt-5'>
          ...
          <div className='text-gray-700 text-xl '>
            ...
            <div className={`underline text-xl py-3 xl:py-5 ${fontstyles.lightFont_Serpentine}`}>‘‘Somos el taller de las cosas bien hechas‘‘.</div>
            
            <div className='inline font-bold text-base xl:text-xl pr-1'>OSA<span className={fontstyles.italicFont}>MEC</span>.</div> 
